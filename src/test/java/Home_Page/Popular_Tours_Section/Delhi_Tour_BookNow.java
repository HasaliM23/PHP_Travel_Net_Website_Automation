...
public class Delhi_Tour_BookNow {
    ...
    @Test
    public void Delhi_Tour_Book() throws InterruptedException {

        wait = new WebDriverWait(driver, Duration.ofSeconds(30));

        WebElement clickDelihiCard = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='fadein']/main/div[3]/div/div[2]/div[1]/div/div/a[3]/div")));
