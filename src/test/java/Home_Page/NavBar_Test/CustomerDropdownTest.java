...
public class CustomerDropdownTest {
    ...
    @Test
    public void verifyCustomerDropdownLoginFunctionality() throws InterruptedException {
    ...
    public void verifyAgentDropdownSignUpFunctionality() throws InterruptedException {
