...
public class Thailand_Tour_BookNow {
    ...
    @Test
    public void Thailand_Tour_Book() throws InterruptedException {

        wait = new WebDriverWait(driver, Duration.ofSeconds(30));

        WebElement clickThailandCard = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='fadein']/main/div[3]/div/div[2]/div[1]/div/div/a[5]/div/div")));

        //scroll

        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);" , clickThailandCard);

        Thread.sleep(2000);

        ((JavascriptExecutor) driver).executeScript("arguments[0].click();", clickThailandCard);
