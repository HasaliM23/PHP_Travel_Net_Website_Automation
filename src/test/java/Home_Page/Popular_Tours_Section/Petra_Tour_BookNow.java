...
public class Petra_Tour_BookNow {
    ...
    @Test
    public void petra_Tour_Book() throws InterruptedException {

        wait = new WebDriverWait(driver, Duration.ofSeconds(30));

        WebElement clickPetra = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='fadein']/main/div[3]/div/div[2]/div[1]/div/div/a[2]/div/img")));

        // Scroll to element
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", clickPetra);

        // Add a small wait for animations
        Thread.sleep(2000);

        ((JavascriptExecutor) driver).executeScript("arguments[0].click();", clickPetra);
