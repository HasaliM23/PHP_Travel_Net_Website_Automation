...
public class Hyundai_i10_car_Book_Now {
    ...
    @Test
    public void Hyundai_i10_car_Book() throws InterruptedException {
        wait = new WebDriverWait(driver, Duration.ofSeconds(30));


        WebElement clickBookNowButton = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='fadein']/main/div[4]/div/section/div[2]/div/div/div/div[2]/div/div[1]/form/div/div[2]/div[3]/button")));
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", clickBookNowButton);
        Thread.sleep(2000);
        ((JavascriptExecutor) driver).executeScript("arguments[0].click();", clickBookNowButton);
