...
public class Toyota_Car_2023_Book_Now {
    ...
    @Test
    public void Toyota_Car_2023_Book() throws InterruptedException {

        wait = new WebDriverWait(driver,Duration.ofSeconds(30));

        WebElement bookNowToyota  = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='fadein']/main/div[4]/div/section/div[2]/div/div/div/div[2]/div/div[3]/form/div/div[2]/div[3]/button")));
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", bookNowToyota);
        Thread.sleep(2000);
        ((JavascriptExecutor) driver).executeScript("arguments[0].click();", bookNowToyota);
